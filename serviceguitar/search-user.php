        ...
        <div class="container-xl">
                    ...
                    <span class="navbar-toggler-icon"></span>
                     ...
                     <div class="navbar-nav mx-lg-auto">
                        <a class="nav-item nav-link active" href="home-user.php" aria-current="page">Product</a>
            ...
            <div class="row height d-flex justify-content-center align-items-center">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $index = 1;
                            $product = mysqli_query($conn, "SELECT * FROM product WHERE $where ORDER BY id DESC");
