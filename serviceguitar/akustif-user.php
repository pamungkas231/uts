...
<head>
    ...
    <title>Akustif | sparepart guitar</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-0 py-3">
        <div class="container-xl">
                    ...
                    <<div class="navbar-nav mx-lg-auto">
                        ...
                        <a class="nav-item nav-link active" href="akustif-user.php">Akustif</a>
                        <a class="nav-item nav-link" href="elektrik-user.php">Elektrik</a>
            ...
            <div class="row height d-flex justify-content-center align-items-center">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php 
                        $index = 1;
                            $product = mysqli_query($conn, "SELECT * FROM product WHERE kategori = 1 ORDER BY id DESC");
