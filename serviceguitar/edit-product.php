<?php
    ...
    $kategori = mysqli_query($conn, "SELECT * FROM product WHERE id = '".$_GET['id']."'");
            ...
            <div class="containerbodyadd"> 
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" id="exampleInputEmail1"  required value="<?php echo $data->name ?>">
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Image Product</label>
                        <input type="file" class="form-control" name="image" id="exampleInputEmail1"  required value="<?php echo $data->image ?>">
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Harga</label>
                        <input type="number" class="form-control" name="harga" id="exampleInputEmail1"  required value="<?php echo $data->harga ?>">
                    </div>
                    <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="kategori" required value="<?php echo $data->kategori ?>">
                    ...
                    <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="status" required value="<?php echo $data->status ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="deskripsi" required value="<?php echo $data->deskripsi ?>"></textarea>
                    </div>
...
<?php 
    if(isset($_POST['btnsubmit'])){
      ...
      if(!in_array($type2, $typeok)){
        ...
        $insert = mysqli_query($conn, "UPDATE product SET 
        kategori = '".$kategori."',
        name = '".$name."',
        harga = '".$harga."',
        status = '".$status."',
